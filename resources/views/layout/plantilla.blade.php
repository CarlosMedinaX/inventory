  ...
  <nav class="navbar navbar-expand-lg bg-body-primary bg-primary">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <div class="dropdown position-absolute end-0 me-3 bd-mode-toggle">
        ...
        {{-- <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="{{route ('proveedores.index')}}">Proveedores</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{route("estantes.index")}}" aria-current="page" href="#">Estantes</a>
          </li>
          <li class="nav-item">
