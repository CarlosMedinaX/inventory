<!DOCTYPE html>
 <html lang="en" data-bs-theme="dark" {{-- el data-bs-theme="dark" es para colocar el modo oscuro, pero no con toggle --}}> 
<head>
  <meta charset="UTF-8">
  ...
  {{-- los estilos no agarraban por el orde, hay que colocar cierto orden para que agarren --}}
...
{{--  
      <div class="btn-group">
        <button class="btn border border-black dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
          Configuración
        </button>
        <ul class="dropdown-menu">
          ...
          <li><a class="dropdown-item" href="{{route("estantes.index")}}">Estantes</a></li>
      ...
      <div class="dropdown ms-auto bd-mode-toggle">
        ...
        {{-- con dropdown-menu-md-end hago que el toggle en md hacia abajo se coloque en el lugar correcto --}}
        <ul class="dropdown-menu dropdown-menu-md-end shadow" aria-labelledby="bd-theme-text">
          <li>
...
@show
  ...
  {{-- este br para separar el mensaje de exito de la paginacion --}}
  <br>
  @yield('content')
  ...
  {{-- este div es para dar un poco de margin abajo y que la paginacion no pegue completamente del viewport --}}
  <div class="mb-4">
